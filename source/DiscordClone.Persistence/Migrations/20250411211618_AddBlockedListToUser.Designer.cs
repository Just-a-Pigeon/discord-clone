...
namespace DiscordClone.Persistence.Migrations
{
    ...
    [Migration("20250411211618_AddBlockedListToUser")]
    partial class AddBlockedListToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DiscordClone.Domain.Entities.Consultation.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("ApplicationUserId")
                        .HasDatabaseName("ix_asp_net_users_application_user_id");
            ...
            modelBuilder.Entity("DiscordClone.Domain.Entities.Consultation.ApplicationUser", b =>
                {
                    b.HasOne("DiscordClone.Domain.Entities.Consultation.ApplicationUser", null)
                        ...
                        .HasConstraintName("fk_asp_net_users_asp_net_users_application_user_id");
                });
